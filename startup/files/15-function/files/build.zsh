...
function shell-files-build-include() {
    local files_dir="$1"
    local output_file="$2"
    ...
    shell files build "$files_dir" "$output_file"
    source "$output_file"
    return $CODE_OK
}
